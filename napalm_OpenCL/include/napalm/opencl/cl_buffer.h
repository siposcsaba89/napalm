...
namespace napalm {
    namespace cl {
        struct CLBuffer : public Buffer
        {
            ...
            virtual void write(const void * data, size_t offet, size_t size, int32_t command_queue);
            virtual void read(void * data, int32_t command_queue) const;
            virtual void read(void * data, size_t offet, size_t size, int32_t command_queue) const;
            virtual void * map(MapMode mode, int32_t command_queue);
            virtual void * map(MapMode mode, size_t offset, size_t size, int32_t command_queue);
